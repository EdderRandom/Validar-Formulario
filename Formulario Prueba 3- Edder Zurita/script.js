...
// Seccion para mostar todo desde un solo html, agregando funciones a lops botones para poder llamar a cada elemento
document.getElementById("boton-quienessomos").addEventListener("click", function (e){
    e.preventDefault();
    showSection("section-quienessomos")
});

document.getElementById("boton-separtedenosotros").addEventListener("click", function (e){
    e.preventDefault();
    showSection("section-separtedenosotros")
});
...
//  Esta seccion me hace la carga de la pagina principal 
